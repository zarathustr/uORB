...
struct orb_metadata {
  ...
  uint32_t o_queue_size; /**< semicolon separated list of fields (with type) */
};
 ...
 */
#define ORB_MULTI_MAX_INSTANCES 7
 ...
 */
orb_publication_t *__orb_create_publication(
 ...
 */
orb_publication_t *__orb_create_publication_multi(
 ...
 */
bool __orb_destroy_publication(orb_publication_t **handle_ptr) __EXPORT;
 ...
 */
bool __orb_publish(orb_publication_t *handle, const void *data) __EXPORT;
 ...
 */
bool __orb_publish_anonymous(const struct orb_metadata *meta,
 ...
 */
static inline bool __orb_publish_auto(const struct orb_metadata *meta,
  ...
  if (!*handle_ptr) {
    *handle_ptr = __orb_create_publication_multi(meta, instance);
    if (!*handle_ptr) {
      return false;
    }
  }
  return __orb_publish(*handle_ptr, data);
}
 ...
 */
orb_subscription_t *__orb_create_subscription(
    const struct orb_metadata *meta) __EXPORT;
 ...
 */
orb_subscription_t *__orb_create_subscription_multi(
 ...
 * @return true on success.
 */
bool __orb_destroy_subscription(orb_subscription_t **handle_ptr) __EXPORT;
 ...
 */
bool __orb_copy(orb_subscription_t *handle, void *buffer) __EXPORT;
 ...
 * @return @see orb_copy()
 */
bool __orb_copy_anonymous(const struct orb_metadata *meta, void *buffer) __EXPORT;
 ...
 * using this handle.
 */
bool __orb_check_update(orb_subscription_t *handle) __EXPORT;

/**
 * If the message is updated, copy the message.
 * See orb_check_update() and orb_copy().
 */
static inline bool __orb_check_and_copy(orb_subscription_t *handle,
                                      void *buffer) {
  return __orb_check_update(handle) && __orb_copy(handle, buffer);
}
 ...
 */
bool __orb_exists(const struct orb_metadata *meta,
 ...
 */
unsigned int __orb_group_count(const struct orb_metadata *meta) __EXPORT;
 ...
 * @return
 */
bool __orb_get_topic_status(const struct orb_metadata *meta,
 ...
 */
int __orb_poll(struct orb_pollfd *fds, unsigned int nfds,
